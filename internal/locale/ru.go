...
var ru = map[string]string{
	...
	"help.text": "*Доступные команды:*\n\n" +
		...
		"/defaults — Задать проект и тип задачи по умолчанию (для /createfast)\n\n" +
		"*Уведомления:*\n" +
	...
	"admin.diagnose.usage":            "Использование: `/diagnose [telegram_user_id]`\nБез аргумента — диагностика своего подключения.",
	"admin.diagnose.user_not_found":   "Пользователь `%d` не найден.",
	"admin.diagnose.not_connected":    "*🔧 Диагностика — `%d`*\n\nПользователь не подключён к Jira.",
	"admin.diagnose.header":           "*🔧 Диагностика — `%d`*",
	"admin.diagnose.site":             "Сайт: %s",
	"admin.diagnose.account":          "Аккаунт: %s",
	"admin.diagnose.expires":          "Токен истекает: %s",
	"admin.diagnose.scopes_summary":   "Скоупы — выдано: %d, требуется: %d",
	"admin.diagnose.scopes_unknown":   "Выданные скоупы неизвестны (пользователь подключался до того, как был добавлен учёт скоупов — переподключитесь, чтобы записать).",
	"admin.diagnose.scopes_ok":        "✅ Все требуемые скоупы выданы.",
	"admin.diagnose.scopes_missing":   "⚠️ Не хватает скоупов (%d):\n```\n%s\n```",
	"admin.diagnose.scopes_hybrid":    "🚨 *Гибридный токен.* В выданных скоупах остались классические: `%s`. Нужен /disconnect → /connect, даже если в Developer Console их уже нет — токен помнит исходный grant.",
	"admin.diagnose.scopes_list":      "Выданные скоупы (как есть):\n```\n%s\n```",
	"admin.diagnose.advice_hybrid":    "🔁 *Действие:* токен сам по себе гибридный (видны классические скоупы выше). Состояние токена замораживается в момент выдачи — даже если консоль уже почищена, нужны /disconnect и /connect для нового granular-only токена.",
	"admin.diagnose.probes_header":    "*Проверки API:*",
	"admin.diagnose.probe_ok":         "✅ %s → OK",
	"admin.diagnose.probe_fail":       "❌ %s → %d: %s",
	"admin.diagnose.probe_error":      "❌ %s → %s",
	"admin.diagnose.advice_reconnect": "🔁 *Действие:* пользователю нужно сделать /disconnect, затем /connect — refresh сохраняет исходный набор скоупов, новый выдаст только повторная авторизация.",
	...
	"create.template_no_sample":   "Шаблон \"%s\" выбран. Не нашёл прошлую задачу с этим шаблоном — введите описание вручную.",
	...
	"calendar.menu.title":        "📅 *Календарь*\n%s",
	"calendar.status.set":        "URL: подключён\nУведомления: %s\nЗа сколько минут: %d",
	"calendar.status.unset":      "Календарь не настроен.",
	"calendar.status.disabled":   "выкл",
	"calendar.status.enabled":    "вкл",
	"calendar.status.last_error": "\nОшибка последней синхронизации: %s",
	"calendar.btn.set_url":       "🔗 Указать URL",
	"calendar.btn.remove":        "🗑 Удалить",
	"calendar.btn.toggle_on":     "🔔 Включить",
	"calendar.btn.toggle_off":    "🔕 Выключить",
	"calendar.btn.rem_5":         "5 мин",
	"calendar.btn.rem_15":        "15 мин",
	"calendar.btn.rem_30":        "30 мин",
	"calendar.btn.rem_60":        "60 мин",
	"calendar.btn.rem_custom":    "✏ Свой",
	"calendar.btn.rem_default":   "↺ По умолчанию",
	"calendar.prompt.url":        "Пришлите секретный ICS/iCal URL. Google Calendar: Настройки → ваш календарь → Секретный адрес в формате iCal.",
	"calendar.prompt.reminder":   "За сколько минут до начала события напоминать? (1..1440)",
	"calendar.saved":             "URL календаря сохранён. Скоро начнёте получать напоминания о ближайших событиях.",
	"calendar.removed":           "Календарь удалён.",
	"calendar.invalid":           "Не удалось прочитать URL как календарь: %s",
	"calendar.invalid_minutes":   "Минуты — целое число от 1 до 1440.",
	"calendar.notif.reminder":    "⏰ *%s* начнётся через %d мин%s",
	"calendar.notif.new":         "🆕 Новое событие: *%s*\n%s",
	"calendar.notif.changed":     "✏ Событие изменилось: *%s*\n%s%s",
	"calendar.field.when":        "Когда",
	"calendar.field.where":       "Где",
	"calendar.field.summary":     "Название",
	"calendar.field.description": "Описание",
	"me.calendar.connected":      "\n\n📅 Календарь: подключён (напоминание за %d мин)",
