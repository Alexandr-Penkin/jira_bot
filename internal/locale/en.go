...
var en = map[string]string{
	...
	"admin.diagnose.usage":            "Usage: `/diagnose [telegram_user_id]`\nWithout an ID — diagnoses your own connection.",
	"admin.diagnose.user_not_found":   "User `%d` not found.",
	"admin.diagnose.not_connected":    "*🔧 Diagnose — `%d`*\n\nUser is not connected to Jira.",
	"admin.diagnose.header":           "*🔧 Diagnose — `%d`*",
	"admin.diagnose.site":             "Site: %s",
	"admin.diagnose.account":          "Account: %s",
	"admin.diagnose.expires":          "Token expires: %s",
	"admin.diagnose.scopes_summary":   "Scopes — granted: %d, required: %d",
	"admin.diagnose.scopes_unknown":   "Granted scopes unknown (user connected before scope tracking was added — reconnect to record).",
	"admin.diagnose.scopes_ok":        "✅ All required scopes present.",
	"admin.diagnose.scopes_missing":   "⚠️ Missing scopes (%d):\n```\n%s\n```",
	"admin.diagnose.scopes_hybrid":    "🚨 *Hybrid token detected.* Classic scopes still embedded in the token: `%s`. Re-minting (/disconnect → /connect) is required even if the Developer Console no longer lists them.",
	"admin.diagnose.scopes_list":      "Granted (raw):\n```\n%s\n```",
	"admin.diagnose.advice_hybrid":    "🔁 *Action:* the token itself is hybrid (see classic scopes above). Token state is frozen at issuance — even if the Developer Console is now clean, /disconnect + /connect is mandatory to mint a granular-only token.",
	"admin.diagnose.probes_header":    "*Probes:*",
	"admin.diagnose.probe_ok":         "✅ %s → OK",
	"admin.diagnose.probe_fail":       "❌ %s → %d: %s",
	"admin.diagnose.probe_error":      "❌ %s → %s",
	"admin.diagnose.advice_reconnect": "🔁 *Action:* user must run /disconnect then /connect to mint a token that carries the missing scopes — refresh keeps the original grant.",
	...
	"create.choose_template":      "Create a new issue or use a template:",
	"create.blank":                "New issue",
	"create.choose_type":          "Choose issue type:",
	"create.failed_types":         "Failed to load issue types for this project.",
	"create.no_types":             "No issue types available for this project.",
	"create.enter_summary":        "Enter issue summary:",
	"create.summary_too_long":     "Summary is too long (max %d characters).",
	"create.enter_description":    "Enter description (or send any text):",
	"create.desc_too_long":        "Description is too long (max %d characters).",
	"create.template_prefill":     "Description template:\n\n%s\n\nKeep this text or edit it?",
	"create.keep_desc":            "Keep",
	"create.edit_desc":            "Edit",
	"create.choose_priority":      "Choose priority:",
	"create.choose_assignee":      "Choose assignee:",
	"create.assign_me":            "Assign to me",
	"create.search_user":          "Search user",
	"create.search_assignee":      "Enter name to search:",
	"create.assignee_results":     "Select assignee:",
	"create.no_assignee_found":    "No users found. Try again or skip.",
	"create.enter_field":          "Enter value for *%s*:",
	"create.enter_field_number":   "Enter a number for *%s*:",
	"create.choose_field":         "Choose value for *%s*:",
	"create.field_number_invalid": "Please enter a valid number.",
	"create.failed_fields":        "Failed to load fields for this issue type.",
	"create.confirm_title":        "Create issue?",
	"create.field_project":        "Project",
	"create.field_type":           "Type",
	"create.field_summary":        "Summary",
	"create.field_description":    "Description",
	"create.field_priority":       "Priority",
	"create.field_assignee":       "Assignee",
	"create.field_epic":           "Epic",
	"create.choose_epic":          "Choose Epic (required for this issue type):",
	"create.no_epics":             "No active Epics found. Enter an Epic key manually:",
	"create.failed_epics":         "Failed to load Epics.",
	"create.enter_epic_manual":    "Enter Epic key manually",
	...
	"create.template_no_sample":   "Template \"%s\" selected. Couldn't find a prior issue to preview the body — please type your description.",
	"create.confirm":              "Create",
	"create.save_tmpl":            "Save as template",
	"create.success":              "Issue created: [%s](%s)",
	"create.failed":               "Failed to create issue. Please try again.",
	"create.unknown_type":         "Unknown issue type: %s",
	"create.enter_tmpl_name":      "Enter template name:",
	"create.tmpl_name_too_long":   "Template name is too long (max %d characters).",
	"create.tmpl_limit_reached":   "Maximum templates reached (%d). Delete some first.",
	"create.tmpl_saved":           "Template '%s' saved.",
	"create.tmpl_none":            "No saved templates.",
	"create.tmpl_list":            "Your templates (tap to delete):",
	"create.tmpl_deleted":         "Template deleted.",
	...
	"calendar.menu.title":        "📅 *Calendar feed*\n%s",
	"calendar.status.set":        "URL: connected\nReminders: %s\nMinutes before: %d",
	"calendar.status.unset":      "No calendar URL configured.",
	"calendar.status.disabled":   "off",
	"calendar.status.enabled":    "on",
	"calendar.status.last_error": "\nLast fetch error: %s",
	"calendar.btn.set_url":       "🔗 Set URL",
	"calendar.btn.remove":        "🗑 Remove",
	"calendar.btn.toggle_on":     "🔔 Turn on",
	"calendar.btn.toggle_off":    "🔕 Turn off",
	"calendar.btn.rem_5":         "5 min",
	"calendar.btn.rem_15":        "15 min",
	"calendar.btn.rem_30":        "30 min",
	"calendar.btn.rem_60":        "60 min",
	"calendar.btn.rem_custom":    "✏ Custom",
	"calendar.btn.rem_default":   "↺ Default",
	"calendar.prompt.url":        "Paste your iCal/ICS secret URL. In Google Calendar: Settings → your calendar → Secret address in iCal format.",
	"calendar.prompt.reminder":   "How many minutes before each event should I remind you? (1..1440)",
	"calendar.saved":             "Calendar URL saved. You'll start getting reminders for upcoming events.",
	"calendar.removed":           "Calendar removed.",
	"calendar.invalid":           "I couldn't read that as a calendar URL: %s",
	"calendar.invalid_minutes":   "Minutes must be a number between 1 and 1440.",
	"calendar.notif.reminder":    "⏰ *%s* starts in %d min%s",
	"calendar.notif.new":         "🆕 New event: *%s*\n%s",
	"calendar.notif.changed":     "✏ Event changed: *%s*\n%s%s",
	"calendar.field.when":        "When",
	"calendar.field.where":       "Where",
	"calendar.field.summary":     "Title",
	"calendar.field.description": "Details",
	"me.calendar.connected":      "\n\n📅 Calendar: connected (%d min reminder)",
	"me.calendar.not_connected":  "",
}
